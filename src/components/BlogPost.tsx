        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
          <div className="flex max-lg:flex-col bg-white cursor-pointer rounded overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] hover:scale-[1.03] transition-all duration-300">
            <div className="h-64 lg:w-full">
              <img src="images/productList/Images (1).png" alt="Blog Post 1" className="w-full h-full object-cover" />
            </div>
            <div className="p-6">
          ...
          <div className="flex max-lg:flex-col bg-white cursor-pointer rounded overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] hover:scale-[1.03] transition-all duration-300">
            <div className="h-64 lg:w-full">
              <img src="images/productList/Images (2).png" alt="Blog Post 2" className="w-full h-full object-cover" />
            </div>
            <div className="p-6">
          ...
          <div className="flex max-lg:flex-col bg-white cursor-pointer rounded overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] hover:scale-[1.03] transition-all duration-300">
            <div className="h-64 lg:w-full">
              <img src="images/productList/Images (3).png" alt="Blog Post 2" className="w-full h-full object-cover" />
            </div>
            <div className="p-6">
          ...
          <div className="flex max-lg:flex-col bg-white cursor-pointer rounded overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] hover:scale-[1.03] transition-all duration-300">
            <div className="h-64 lg:w-full">
              <img src="images/productList/Images (4).png" alt="Blog Post 2" className="w-full h-full object-cover" />
            </div>
            <div className="p-6">
