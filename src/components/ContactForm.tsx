  ...
  return (
    ...
    <div className="grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-4xl bg-white font-[sans-serif]">
            <div>
                ...
                <p className="text-sm text-gray-500 mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam tenetur officiis in voluptatem animi earum, architecto temporibus itaque! Nemo, possimus.</p>
